...
\begin{figure}[H]
	\centering
	\subfloat[Old Dispatch Tab]{{\includegraphics[scale=0.25]{images/my_projects/input/input-location-dashboard-old.png} }}%
	\qquad
	\subfloat[New Dispatch Tab]{{\includegraphics[scale=0.37]{images/my_projects/input/input-location-dashboard-new.png} }}%
	\caption{
