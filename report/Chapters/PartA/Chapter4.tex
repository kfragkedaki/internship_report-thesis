...
\begin{figure}[H]
	\centering
	\subfloat[Old Dispatch Tab]{{\includegraphics[scale=0.13]{images/my_projects/input/input-location-dashboard-old.png} }}%
	\qquad
	\subfloat[New Dispatch Tab]{{\includegraphics[scale=0.2]{images/my_projects/input/input-location-dashboard-new.png} }}%
	\caption{
