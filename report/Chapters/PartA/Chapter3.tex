...
\begin{figure}[H]
	\centering
	\subfloat[Old Version]{{\includegraphics[scale=0.9]{images/my_projects/feature-add-timestamp-linkToHQ-old.png} }}%
	\qquad
	\subfloat[New Version]{{\includegraphics[scale=0.4]{images/my_projects/feature-add-timestamp-linkToHQ-new-plus-map.png} }}%
	\caption{
